...
class Notice extends SemiOpenStruct
{
    ...
    public function __construct(Honeybadger $honeybadger, array $args = array())
    {
        ...
        $this->cgi_data         = new Environment(Arr::get($args, 'cgi_data'));
        ...
        $this->backtrace = Backtrace::parse($backtrace, array(
            ...
            'config' => $this->honeybadger->config,
        ));
    ...
    {
        return $this->honeybadger->sender->send_to_honeybadger($this->honeybadger, $this);
    }
    ...
    {
        $this->context = $this->honeybadger->context();
