...
class Config extends SemiOpenStruct
{
     ...
     */
    public $default_params_filters = array(
        'password',
     ...
     */
    public $default_backtrace_filters = array(
    ...
    public function __construct(array $config = array())
    {
        ...
        $this->params_filters    = array_merge($this->params_filters, $this->default_params_filters);
        $this->backtrace_filters = array_merge($this->backtrace_filters, $this->default_backtrace_filters);
        $this->ignore            = array_merge($this->ignore, $this->default_ignore);
     ...
     *
     * return boolean The detected log level.
     */
